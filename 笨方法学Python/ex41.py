...
def central_corridor():
    ...
    if action == "shoot!":
        ...
        print("completely ruins his brand new costume his mother bought him, whick")
        ...
        print("Lbhe zbgure vf fb sng, jura fur fvgf nebhaq gur ubhfr, fur fvgf nebhaq fur ubhfr.")
...
def laser_weapon_armory():
    ...
    print("gat the bomb. The code is 3 digits.")
...
def the_bridge():
    ...
    if action == "throw the bomb":
        ...
        print("and balst the lock so the Gothons can't get out.")
